...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}Object.defineProperty(exports,"__esModule",{value:!0});var _react=require("react"),_react2=_interopRequireDefault(_react),_reactBootstrap=require("react-bootstrap");exports.default=function(e){var t=e.className,a=e.controlId,r=e.validationState,l=e.optionValues,o=e.multiple,n=e.label,c=e.value,u=e.help,i=e.onChange,p=e.onBlur,s=e.placeholder;return _react2.default.createElement(_reactBootstrap.FormGroup,{className:t,controlId:a,validationState:r},_react2.default.createElement(_reactBootstrap.ControlLabel,null,n),_react2.default.createElement(_reactBootstrap.FormControl,{componentClass:"select",placeholder:s,multiple:o,value:o?c||[]:c,onChange:i,onBlur:p},l.map(function(e){return _react2.default.createElement("option",{key:e.id,value:e.id.toString()},e.name||e.text)})),_react2.default.createElement(_reactBootstrap.HelpBlock,null,u))};
...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function _inherits(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,t){for(var r=0;r<t.length;r++){var o=t[r];o.enumerable=o.enumerable||!1,o.configurable=!0,"value"in o&&(o.writable=!0),Object.defineProperty(e,o.key,o)}}return function(t,r,o){return r&&e(t.prototype,r),o&&e(t,o),t}}(),_react=require("react"),_react2=_interopRequireDefault(_react),_reactBootstrap=require("react-bootstrap"),_reactFormstate=require("react-formstate"),_Select=require("../inputs/bootstrap/Select.jsx"),_Select2=_interopRequireDefault(_Select),_UserAccount=require("../forms/UserAccount.jsx"),_UserAccount2=_interopRequireDefault(_UserAccount),_Event=require("../forms/Event.jsx"),_Event2=_interopRequireDefault(_Event),DemoView=function(e){function t(e){_classCallCheck(this,t);var r=_possibleConstructorReturn(this,(t.__proto__||Object.getPrototypeOf(t)).call(this,e));return r.state={formId:"1",key:0,edit:!1,showOnBlur:!1,validateOnBlur:!1},r.forms={1:{name:"User Account (async validation)",type:_UserAccount2.default,model:{id:123,name:"Huckle",username:"huckle"}},2:{name:"Event (non-HTML input)",type:_Event2.default,model:{id:123,name:"Travel to Europe (I wish!)",from:"2019-07-12T18:32:24.402Z",to:"2019-07-26T18:32:24.402Z"}}},r}return _inherits(t,_react.Component),_createClass(t,[{key:"render",value:function(){var e=this,t=this.forms[this.state.formId].type;return _react2.default.createElement("div",null,_react2.default.createElement(_reactBootstrap.Jumbotron,null,_react2.default.createElement("h1",null,"react-formstate-demo"),_react2.default.createElement(_Select2.default,{className:"demo-form-select",controlId:"formSelect",label:"Select a form",optionValues:Object.keys(this.forms).map(function(t){return{id:t,name:e.forms[t].name}}),value:this.state.formId,onChange:function(t){return e.setState({edit:!1,formId:t.target.value})}}),_react2.default.createElement(_reactBootstrap.ButtonToolbar,{className:"demo-toolbar"},_react2.default.createElement(_reactBootstrap.Button,{onClick:function(){return e.setState({key:e.state.key+1,edit:!1})}},"Clear Form"),_react2.default.createElement(_reactBootstrap.Button,{onClick:function(){return e.setState({key:e.state.key+1,edit:!0})}},"Inject Model"),_react2.default.createElement(_reactBootstrap.Button,{onClick:function(){return e.toggleShowOnBlur()}},this.state.showOnBlur?"Show onChange":"Show onBlur"),_react2.default.createElement(_reactBootstrap.Button,{onClick:function(){return e.toggleValidateOnBlur()}},this.state.validateOnBlur?"No Validation onBlur":"Validate onBlur"))),_react2.default.createElement(t,{key:this.state.key,model:this.state.edit?this.forms[this.state.formId].model:null}))}},{key:"toggleShowOnBlur",value:function(){_reactFormstate.FormState.setShowMessageOnBlur(!this.state.showOnBlur),this.setState({showOnBlur:!this.state.showOnBlur})}},{key:"toggleValidateOnBlur",value:function(){_reactFormstate.FormState.setEnsureValidationOnBlur(!this.state.validateOnBlur),this.setState({validateOnBlur:!this.state.validateOnBlur})}}]),t}();exports.default=DemoView;
