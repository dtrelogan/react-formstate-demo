...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function _inherits(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,t){for(var r=0;r<t.length;r++){var a=t[r];a.enumerable=a.enumerable||!1,a.configurable=!0,"value"in a&&(a.writable=!0),Object.defineProperty(e,a.key,a)}}return function(t,r,a){return r&&e(t.prototype,r),a&&e(t,a),t}}(),_react=require("react"),_react2=_interopRequireDefault(_react),_reactDom=require("react-dom"),_reactDom2=_interopRequireDefault(_reactDom),_reactFormstate=require("react-formstate"),_reactFormstateValidation=require("react-formstate-validation"),_reactBootstrap=require("react-bootstrap"),_Input=require("./inputs/rfs-bootstrap/Input.jsx"),_Input2=_interopRequireDefault(_Input),_Submit=require("./inputs/bootstrap/Submit.jsx"),_Submit2=_interopRequireDefault(_Submit),_SimpleModal=require("./inputs/bootstrap/SimpleModal.jsx"),_SimpleModal2=_interopRequireDefault(_SimpleModal),_DateInput=require("./inputs/rfs-bootstrap/DateInput.jsx"),_DateInput2=_interopRequireDefault(_DateInput),_moment=require("moment"),_moment2=_interopRequireDefault(_moment),ChangePasswordForm=function(e){function t(e){_classCallCheck(this,t);var r=_possibleConstructorReturn(this,(t.__proto__||Object.getPrototypeOf(t)).call(this,e));return r.formState=new _reactFormstate.FormState(r),r.state=r.formState.injectModel(e.model),r.formState.add(r.state,"when",e.model&&e.model.when?(0,_moment2.default)(e.model.when):null,!0),r.updateBlurSettings(e),r}return _inherits(t,_react.Component),_createClass(t,[{key:"updateBlurSettings",value:function(e){this.formState.setShowMessageOnBlur(e.showOnBlur),this.formState.setEnsureValidationOnBlur(e.validateOnBlur)}},{key:"componentWillReceiveProps",value:function(e){this.updateBlurSettings(e)}},{key:"validateNewPassword",value:function(e,t){if(!_reactFormstateValidation.library.regex(e,/^\S+$/))return"Password must not contain whitespace";if(e.length<8)return"Password must be at least 8 characters";if(e.length<12){var r=t.getFieldState("newPassword");return r.setValid("Passwords are ideally at least 12 characters"),void r.set("warn",!0)}}},{key:"validateConfirmNewPassword",value:function(e,t){if(e!==t.get("newPassword"))return"Password confirmation does not match"}},{key:"validateWhen",value:function(e){if(!e)return"When is required"}},{key:"render",value:function(){var e=this;return _react2.default.createElement(_reactFormstate.Form,{formState:this.formState,onSubmit:function(t){return e.handleSubmit(t)}},_react2.default.createElement(_reactBootstrap.Grid,{fluid:!0},_react2.default.createElement(_reactBootstrap.Row,null,_react2.default.createElement(_reactBootstrap.Col,{xs:12,sm:6,lg:4},_react2.default.createElement(_Input2.default,{formField:"name",label:"Name",required:!0,fsv:function(e){return e.minLength(8).msg("must be 8 chars")},autoComplete:"off"})),_react2.default.createElement(_reactBootstrap.Col,{xs:12,sm:6,lg:4},_react2.default.createElement(_DateInput2.default,{formField:"when",label:"When",required:"-"})),_react2.default.createElement(_reactBootstrap.Col,{xsHidden:!0,lg:4})),_react2.default.createElement(_reactBootstrap.Row,null,_react2.default.createElement(_reactBootstrap.Col,{xs:12,sm:6,lg:4},_react2.default.createElement(_Input2.default,{formField:"newPassword",type:"password",label:"New Password",required:!0,handleValueChange:function(t){return e.handlePasswordChange(t)}})),_react2.default.createElement(_reactBootstrap.Col,{xs:12,sm:6,lg:4},_react2.default.createElement(_Input2.default,{formField:"confirmNewPassword",type:"password",label:"Confirm New Password",required:!0})),_react2.default.createElement(_reactBootstrap.Col,{xsHidden:!0,lg:4})),_react2.default.createElement(_reactBootstrap.Row,null,_react2.default.createElement(_reactBootstrap.Col,{xs:12},_react2.default.createElement(_Submit2.default,{invalid:this.formState.isInvalid(this.formState.getu("showOnBlur")),grabRef:function(t){return e.submitButton=t}})))),_react2.default.createElement(_SimpleModal2.default,{title:"Model Output",show:Boolean(this.state.modelOutput),onClose:function(){return e.setState({modelOutput:null})}},_react2.default.createElement("pre",null,JSON.stringify(this.state.modelOutput,null,2))))}},{key:"handlePasswordChange",value:function(e){var t=this.formState.createUnitOfWork();t.set("newPassword",e).validate(),t.set("confirmNewPassword",""),t.updateFormState()}},{key:"handleSubmit",value:function(e){e.preventDefault(),_reactDom2.default.findDOMNode(this.submitButton).focus();var t=this.formState.createUnitOfWork().createModel();t&&this.setState({modelOutput:t})}}]),t}();exports.default=ChangePasswordForm;

},{"./inputs/bootstrap/SimpleModal.jsx":6,"./inputs/bootstrap/Submit.jsx":7,"./inputs/rfs-bootstrap/DateInput.jsx":8,"./inputs/rfs-bootstrap/Input.jsx":9,"moment":307,"react":"react","react-bootstrap":"react-bootstrap","react-dom":"react-dom","react-formstate":311,"react-formstate-validation":310}],2:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function _inherits(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,t){for(var r=0;r<t.length;r++){var o=t[r];o.enumerable=o.enumerable||!1,o.configurable=!0,"value"in o&&(o.writable=!0),Object.defineProperty(e,o.key,o)}}return function(t,r,o){return r&&e(t.prototype,r),o&&e(t,o),t}}(),_react=require("react"),_react2=_interopRequireDefault(_react),_reactBootstrap=require("react-bootstrap"),_RadioGroup=require("./inputs/bootstrap/RadioGroup.jsx"),_RadioGroup2=_interopRequireDefault(_RadioGroup),_DemoForm=require("./DemoForm.jsx"),_DemoForm2=_interopRequireDefault(_DemoForm),DemoView=function(e){function t(e){_classCallCheck(this,t);var r=_possibleConstructorReturn(this,(t.__proto__||Object.getPrototypeOf(t)).call(this,e));return r.state={key:0,edit:!1,showOnBlur:!1,validateOnBlur:!1},r.model={name:"Buster Brown",newPassword:"password",confirmNewPassword:"password",when:"2017-07-12T18:32:24.402Z"},r}return _inherits(t,_react.Component),_createClass(t,[{key:"render",value:function(){var e=this;return _react2.default.createElement("div",null,_react2.default.createElement(_reactBootstrap.Jumbotron,null,_react2.default.createElement("h1",null,"react-formstate-demo"),_react2.default.createElement(_reactBootstrap.ButtonToolbar,{className:"demo-toolbar"},_react2.default.createElement(_reactBootstrap.Button,{onClick:function(){return e.setState({key:e.state.key+1,edit:!1})}},"Clear Form"),_react2.default.createElement(_reactBootstrap.Button,{onClick:function(){return e.setState({key:e.state.key+1,edit:!0})}},"Inject Model"),_react2.default.createElement(_reactBootstrap.Button,{onClick:function(){return e.setState({showOnBlur:!e.state.showOnBlur})}},this.state.showOnBlur?"Show onChange":"Show onBlur"),_react2.default.createElement(_reactBootstrap.Button,{onClick:function(){return e.setState({validateOnBlur:!e.state.validateOnBlur})}},this.state.validateOnBlur?"No Validation onBlur":"Validate onBlur"))),_react2.default.createElement(_DemoForm2.default,{key:this.state.key,model:this.state.edit?this.model:null,showOnBlur:this.state.showOnBlur,validateOnBlur:this.state.validateOnBlur}))}}]),t}();exports.default=DemoView;

},{"./DemoForm.jsx":1,"./inputs/bootstrap/RadioGroup.jsx":5,"react":"react","react-bootstrap":"react-bootstrap"}],3:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}Object.defineProperty(exports,"__esModule",{value:!0});var _react=require("react"),_react2=_interopRequireDefault(_react),_reactBootstrap=require("react-bootstrap"),_reactDatepicker=require("react-datepicker"),_reactDatepicker2=_interopRequireDefault(_reactDatepicker);exports.default=function(e){return _react2.default.createElement(_reactBootstrap.FormGroup,{className:e.className,controlId:e.controlId,validationState:e.validationState},_react2.default.createElement(_reactBootstrap.ControlLabel,null,e.label),_react2.default.createElement("div",{className:"date-input-container"},_react2.default.createElement(_reactDatepicker2.default,{className:"form-control",selected:e.value,onChange:e.onChange,onBlur:e.onBlur})),_react2.default.createElement(_reactBootstrap.HelpBlock,null,e.help))};

},{"react":"react","react-bootstrap":"react-bootstrap","react-datepicker":308}],4:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}Object.defineProperty(exports,"__esModule",{value:!0});var _react=require("react"),_react2=_interopRequireDefault(_react),_reactBootstrap=require("react-bootstrap");exports.default=function(e){var t=!1===e.showFeedback?null:_react2.default.createElement(_reactBootstrap.FormControl.Feedback,null);return _react2.default.createElement(_reactBootstrap.FormGroup,{className:e.className,controlId:e.controlId,validationState:e.validationState},_react2.default.createElement(_reactBootstrap.ControlLabel,null,e.label),_react2.default.createElement(_reactBootstrap.FormControl,{type:e.type||"text",value:e.value,placeholder:e.placeholder,onChange:e.onChange,onBlur:e.onBlur,disabled:e.disabled,autoFocus:e.autoFocus,autoComplete:e.autoComplete}),t,_react2.default.createElement(_reactBootstrap.HelpBlock,null,e.help))};

},{"react":"react","react-bootstrap":"react-bootstrap"}],5:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}Object.defineProperty(exports,"__esModule",{value:!0});var _react=require("react"),_react2=_interopRequireDefault(_react),_reactBootstrap=require("react-bootstrap");exports.default=function(e){var t=e.controlId,a=e.label,r=e.inline,l=e.buttonValues,n=e.value,o=e.help,u=e.onChange,c=e.disabled,d=null;a&&(d=_react2.default.createElement("div",null,_react2.default.createElement(_reactBootstrap.ControlLabel,null,a)));var i=null;r&&(i=_react2.default.createElement("span",null,"  "));var _=l.map(function(e){return _react2.default.createElement("span",{key:e.id},_react2.default.createElement(_reactBootstrap.Radio,{value:e.id,checked:n===e.id.toString(),onChange:u,inline:r,disabled:c},e.text),i)});return _react2.default.createElement(_reactBootstrap.FormGroup,{controlId:t},d,_,_react2.default.createElement(_reactBootstrap.HelpBlock,null,o))};
...
},{"react":"react","react-bootstrap":"react-bootstrap","react-dom":"react-dom"}],7:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}Object.defineProperty(exports,"__esModule",{value:!0});var _react=require("react"),_react2=_interopRequireDefault(_react),_reactBootstrap=require("react-bootstrap");exports.default=function(e){var t=e.bsStyle,r=e.bsSize,a=e.message,i=e.invalid,n=e.validating,l=e.uploading,u=e.disabled,o=e.grabRef,s="primary",d="Submit";return i&&(s="danger",d="Please fix validation errors"),n&&(s="warning",d="Waiting for validation..."),l&&(s="warning",d="Waiting for upload..."),t&&(s=t),a&&(d=a),_react2.default.createElement("div",null,_react2.default.createElement(_reactBootstrap.Button,{type:"submit",bsStyle:s,disabled:i||n||l||u,bsSize:r,ref:o},d))};

},{"react":"react","react-bootstrap":"react-bootstrap"}],8:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _objectWithoutProperties(e,t){var a={};for(var r in e)t.indexOf(r)>=0||Object.prototype.hasOwnProperty.call(e,r)&&(a[r]=e[r]);return a}Object.defineProperty(exports,"__esModule",{value:!0});var _extends=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var a=arguments[t];for(var r in a)Object.prototype.hasOwnProperty.call(a,r)&&(e[r]=a[r])}return e},_react=require("react"),_react2=_interopRequireDefault(_react),_DateInput=require("../bootstrap/DateInput.jsx"),_DateInput2=_interopRequireDefault(_DateInput),_InputHoc=require("./InputHoc.jsx"),_InputHoc2=_interopRequireDefault(_InputHoc),DateInput=function(e){var t=e.fieldState,a=e.handleValueChange,r=e.showValidationMessage,n=e.validationState,o=e.help,u=_objectWithoutProperties(e,["fieldState","handleValueChange","showValidationMessage","validationState","help"]);return _react2.default.createElement(_DateInput2.default,_extends({controlId:t.getKey(),validationState:n,value:t.getValue(),onChange:a,onBlur:r,help:o},u))},DateInputHoc=(0,_InputHoc2.default)(DateInput);DateInputHoc.rfsNoCoercion=!0,exports.default=DateInputHoc;

},{"../bootstrap/DateInput.jsx":3,"./InputHoc.jsx":10,"react":"react"}],9:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _objectWithoutProperties(e,t){var r={};for(var a in e)t.indexOf(a)>=0||Object.prototype.hasOwnProperty.call(e,a)&&(r[a]=e[a]);return r}Object.defineProperty(exports,"__esModule",{value:!0});var _extends=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var r=arguments[t];for(var a in r)Object.prototype.hasOwnProperty.call(r,a)&&(e[a]=r[a])}return e},_react=require("react"),_react2=_interopRequireDefault(_react),_Input=require("../bootstrap/Input.jsx"),_Input2=_interopRequireDefault(_Input),_InputHoc=require("./InputHoc.jsx"),_InputHoc2=_interopRequireDefault(_InputHoc),Input=function(e){var t=e.fieldState,r=e.handleValueChange,a=e.showValidationMessage,n=e.validationState,u=e.help,o=_objectWithoutProperties(e,["fieldState","handleValueChange","showValidationMessage","validationState","help"]);return _react2.default.createElement(_Input2.default,_extends({controlId:t.getKey(),validationState:n,value:t.getValue(),onChange:function(e){return r(e.target.value)},onBlur:a,help:u},o))};exports.default=(0,_InputHoc2.default)(Input);

},{"../bootstrap/Input.jsx":4,"./InputHoc.jsx":10,"react":"react"}],10:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _objectWithoutProperties(e,t){var r={};for(var a in e)t.indexOf(a)>=0||Object.prototype.hasOwnProperty.call(e,a)&&(r[a]=e[a]);return r}Object.defineProperty(exports,"__esModule",{value:!0});var _extends=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var r=arguments[t];for(var a in r)Object.prototype.hasOwnProperty.call(r,a)&&(e[a]=r[a])}return e},_react=require("react"),_react2=_interopRequireDefault(_react);exports.default=function(e){return function(t){var r=t.className,a=t.required,i=t.formState,n=t.fieldState,s=_objectWithoutProperties(t,["className","required","formState","fieldState"]),o=null,l=null;return!n.isMessageVisible()&&i.showMessageOnBlur()||(n.isValid()&&(o=n.get("warn")?"warning":"success"),n.isValidating()&&(o="warning"),n.isInvalid()&&(o="error"),l=n.getMessage()),_react2.default.createElement(e,_extends({className:(r||"")+" "+(a?"required":""),fieldState:n,validationState:o,help:l},s))}};

},{"react":"react"}],11:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}require("babel-polyfill");var _react=require("react"),_react2=_interopRequireDefault(_react),_reactDom=require("react-dom"),_reactDom2=_interopRequireDefault(_reactDom),_DemoView=require("./components/DemoView.jsx"),_DemoView2=_interopRequireDefault(_DemoView),_reactFormstate=require("react-formstate"),_reactFormstateValidation=require("react-formstate-validation");_reactFormstateValidation.validationAdapter.plugInto(_reactFormstate.FormState),_reactDom2.default.render(_react2.default.createElement(_DemoView2.default,null),document.getElementById("react-mount-point"));

},{"./components/DemoView.jsx":2,"babel-polyfill":12,"react":"react","react-dom":"react-dom","react-formstate":311,"react-formstate-validation":310}],12:[function(require,module,exports){
(function (global){
"use strict";
...
},{"core-js/fn/regexp/escape":13,"core-js/shim":306,"regenerator-runtime/runtime":314}],13:[function(require,module,exports){
...
},{"moment":307,"react":"react","react-onclickoutside":313}],309:[function(require,module,exports){
module.exports = {
...
},{"./content/en-us/default.js":309}],311:[function(require,module,exports){
'use strict';
...
var FormState = exports.FormState = function () {
  ...
  _createClass(FormState, [{
    ...
    value: function isInvalid(visibleMessagesOnly) {
      var visibleOnly = this.showMessageOnBlur();
...
},{"./generateOutsideCheck":312,"react":"react","react-dom":"react-dom"}],314:[function(require,module,exports){
(function (global){
/**
